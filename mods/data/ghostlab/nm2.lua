...
local move = 14; -- how much it moves before going the other direction
...
function onUpdate(elapsed)
    ...
    currentBeat = (songPos / 240) * (bpm / 140) --this is basically speed, idk how to adjust it

    if curStep >= 2316 and curStep < 2320 then
    ...
    if curStep == 2320 then --this is to revert back to original position
        for i = 0,7 do 

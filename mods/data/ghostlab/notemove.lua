...
local move = 25; -- how much it moves before going the other direction
...
function onUpdate(elapsed)
    ...
    if curStep >= 2064 and curStep < 2316 then
    ...
    if curStep == 2316 then --this is to revert back to original position
        for i = 0,7 do 
